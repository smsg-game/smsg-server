...
@Controller
public class DianJinNewIOSController {
	private static Logger LOG = Logger.getLogger(DianJinNewIOSController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/djIOSPaymentnew.do", method = RequestMethod.GET)
	public ModelAndView payCallback(HttpServletRequest req, HttpServletResponse res) {
		JSONObject jsonObject=new JSONObject();
		PartnerService ps = serviceFactory.getBean(DianJinNewIOSSdk.instance().getPartnerId());
