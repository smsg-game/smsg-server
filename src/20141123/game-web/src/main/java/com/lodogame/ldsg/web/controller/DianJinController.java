...
import com.lodogame.ldsg.partner.service.impl.DianJinNewServiceImpl;
...
public class DianJinController {
	...
	public ModelAndView payCallback(HttpServletRequest req, HttpServletResponse res) {
		...
		if (StringUtils.isNotBlank(s)) {
			 ps = serviceFactory.getBean(DianJinSdk.instance().getPartnerId());
			 ...
			 ps =serviceFactory.getBean("1024");
