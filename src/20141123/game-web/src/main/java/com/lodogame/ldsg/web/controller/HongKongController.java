...
import com.lodogame.ldsg.partner.model.hongkong.HongKongPaymentObj;
import com.lodogame.ldsg.partner.sdk.HongKongSdk;
...
public class HongKongController {
	...
	@RequestMapping(value = "/webApi/hongKongPayment.do")
