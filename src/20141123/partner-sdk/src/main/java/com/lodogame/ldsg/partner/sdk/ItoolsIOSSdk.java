...
import com.lodogame.game.utils.Md5_2;
...
import com.lodogame.game.utils.itools.RSASignature;
...
public class ItoolsIOSSdk extends BaseSdk {
	...
	public boolean verifySession(String session, String uid,long timestamp){
		...
		params.put("sign",EncryptUtil.getMD5("appid="+apiId+"&sessionid="+uid+"_"+session));
