	...
	public boolean checkPayCallbackSign(ApplePaymentObj cb) {
		try {
			...
			if (jObject != null && "0".equals(jObject.getString("status"))) {
				...
				if ("com.sghhr.fanting.zh".equals(receipt.getString("bid"))
						|| "com.sghhr.fanting.eng".equals(receipt.getString("bid"))) {
