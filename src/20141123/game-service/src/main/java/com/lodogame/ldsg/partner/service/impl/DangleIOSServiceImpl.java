...
public class DangleIOSServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(DangleIOSServiceImpl.class);
	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (DangleIOSSdk.instance().verifySession(session, uid)) {
	...
	public boolean doPayment(PaymentObj paymentObj) {
		...
		if (!DangleIOSSdk.instance().checkPayCallbackSign(cb)) {
