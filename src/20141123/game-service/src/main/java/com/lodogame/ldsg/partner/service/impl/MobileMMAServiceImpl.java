...
public class MobileMMAServiceImpl extends BasePartnerService {

	public static Logger logger = Logger.getLogger(MobileMMAServiceImpl.class);
	...
	// partnerUserId, BigDecimal amount, String tradeName,String pkgId) {
	// TradeInfo info = createOrderInfo(partnerId, serverId, partnerUserId,
	// amount, tradeName,pkgId);
	...
	public boolean doPayment(PaymentObj paymentObj) {
		...
		if (!MobileMMASdk.instance().checkPayCallbackSign(cb)) {
