	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (userInfo != null) {
				...
				UserToken userToken = GameApiSdk.getInstance().loadUserToken(userInfo.getUserId(), partnerId, serverId, "0", params);
...
//
//	@Override
//	public String createOrder(String partnerId, String serverId, String partnerUserId, BigDecimal amount, String tradeName,String pkgId, String pkgId, String qn) {
