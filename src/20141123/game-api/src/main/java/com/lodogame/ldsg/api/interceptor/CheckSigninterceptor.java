package com.lodogame.ldsg.api.interceptor;
...
public class CheckSigninterceptor implements HandlerInterceptor {
	private final static Logger log = Logger.getLogger(CheckSigninterceptor.class);
	@Override
	public boolean preHandle(HttpServletRequest request,
		...
		if(sendTime==null){
			throw new ServiceException(ServiceReturnCode.SIGN_CHECK_ERROR, "发送时间字段没有填写");
		}
		...
		md5Str = md5Str+timestamp + Config.ins().getSignKey();
