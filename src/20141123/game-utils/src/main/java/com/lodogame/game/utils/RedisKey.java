...
public class RedisKey {
	...
	private final static String prefix = "ldsg_local";
	...
	public static String getUserMonthlyCardTaskKey() {
		return prefix + "_" + "user_monthly_card_task_key";
	}

	public static void main(String[] args) {
		System.out.println(getCommandKey(10));
	}
